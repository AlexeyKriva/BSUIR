...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        int[] size = getSize();
        box = new Box(size[0], size[1], size[2]);
    ...
    private int[] getSize() {
        try {
            List<String> lines = Files.readAllLines(Paths.get("/Users/aliaksei/Desktop/BSUIR/GIIS/Lab4/size.txt"));
            return createIntArrayFromString(lines.getFirst());
    ...
    private int[] createIntArrayFromString(String line) {
